@php
    use App\Admin;
@endphp
<div class="modal fade clearfix px-5" id="add-checking-request-result" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered " role="document"
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <span id="add-checking-request-result-close" class="fs-4"><i class="fa-regular fa-circle-xmark"
