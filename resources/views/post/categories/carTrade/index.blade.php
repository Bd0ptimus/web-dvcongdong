...
<body class="bodyside">
    ...
    <div class="project-content-section">
        <div class="row d-block justify-content-center" style="width:100%; margin:auto;">
            ...
            <div class="row my-5 newfeed-sec" id="carTrade-newFeed-sec">
...
<script>
    ...
    function newFeedLoadMoreData() {
        $.ajax({
            method: 'post',
            url: '{{ route('post.postCategory.carTrade.loadMore') }}',
            data: {
            ...
            success: function(data) {
                ...
                if (data['error'] == 0) {
                    ...
                    data.data.forEach(function(e) {
                        ...
                        $('#carTrade-newFeed-sec').append(`<div class="row d-block justify-content-center newfeed-container2">
                                                                        <div class="row newFeed-content-small-sec2 d-flex justify-content-start">
                                                                <div class="newFeed-avatar-sec d-flex justify-content-start">
